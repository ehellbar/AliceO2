...
InputSpan::InputSpan(std::function<size_t(size_t)> nofPartsGetter,
                     ...
                     size_t size)
  : mNofPartsGetter{nofPartsGetter}, mRefCountGetter(refCountGetter), mIndicesGetter{std::move(indicesGetter)}, mNextIndicesGetter{std::move(nextIndicesGetter)}, mMessageGetter{std::move(messageGetter)}, mSize{size}
{
}
