...
class InputRecord
{
 public:
  ...
  fair::mq::Message* getMessageAtIndices(size_t slotIdx, DataRefIndices indices) const;
  ...
  struct PartRange {
    ...
    [[nodiscard]] fair::mq::Message* getMessageAtIndices(DataRefIndices idx) const { return record->getMessageAtIndices((int)slot, idx); }
