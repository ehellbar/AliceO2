...
class DigitizerSpec final : public o2::base::BaseDPLDigitizer, public o2::framework::Task
{
 public:
  ...
  /// \brief Constructor
  DigitizerSpec(std::shared_ptr<CalibLoader> calibloader, bool requireCTPInput, const std::vector<o2::detectors::DetID>& detList) : o2::base::BaseDPLDigitizer(o2::base::InitServices::GEOM), o2::framework::Task(), mRequireCTPInput(requireCTPInput), mDetList(detList), mCalibHandler(calibloader) {}
