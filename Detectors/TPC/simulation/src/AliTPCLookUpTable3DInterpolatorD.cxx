...
/// \cond CLASSIMP3
ClassImp(o2::TPC::AliTPCLookUpTable3DInterpolatorD)
/// \endcond
...
)
{
	...
	//interpolatorZ->SetVals(lookupphi);
...
void AliTPCLookUpTable3DInterpolatorD::CopyVals()  {
	fInterpolatorR->SetVals(fLookUpR);
	
	fInterpolatorZ->SetVals(fLookUpZ);
	fInterpolatorPhi->SetVals(fLookUpPhi);
...
) 
{
	...
	//vr = Interpolate3DTableCyl(fOrder, r,z,phi, fNR, fNZ, fNPhi, fRlist, fZlist, fPhilist, fLookUpR);
  vr =  fInterpolatorR->GetValue(r,phi,z);
	//vphi = Interpolate3DTableCyl(fOrder, r,z,phi, fNR, fNZ, fNPhi, fRlist, fZlist, fPhilist, fLookUpPhi);
	vphi =  fInterpolatorPhi->GetValue(r,phi,z);
	//Interpolate3DTableCyl(fOrder, r,z,phi, fNR, fNZ, fNPhi, fRlist, fZlist, fPhilist, fLookUpPhi);
	//vz = Interpolate3DTableCyl(fOrder, r,z,phi, fNR, fNZ, fNPhi, fRlist, fZlist, fPhilist, fLookUpZ);
	vz =  fInterpolatorZ->GetValue(r,phi,z);
	//Interpolate3DTableCyl(fOrder, r,z,phi, fNR, fNZ, fNPhi, fRlist, fZlist, fPhilist, fLookUpZ);
