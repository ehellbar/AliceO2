...
class DigitizerTask : public FairTask
{
 public:
  ...
  void enableSCDistortions(SpaceChargeInterface::SCDistortionType distortionType, TH3 *hisInitialSCDensity=nullptr, int nZSlices=129, int nPhiBins=180, int nRBins=129);
