...
class Digitizer
{
 public:
  ...
  void enableSCDistortions(SpaceChargeInterface::SCDistortionType distortionType, TH3 *hisInitialSCDensity, int nZSlices, int nPhiBins, int nRBins);
 ...
 private:
  ...
  SpaceChargeInterface *mSpaceChargeHandler;  ///< Handler of space-charge distortions
