...
#define SCRATCH_PAD_SEARCH_N 8 // DODO: Change all this to constexpr where possible, like in GPUDefParametersConstants.h
...
#define TPC_NUM_OF_PADS (o2::tpc::constants::MAXGLOBALPADROW * TPC_PADS_PER_ROW_PADDED + GPUCF_PADDING_PAD)
